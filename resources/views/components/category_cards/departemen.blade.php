<div class="group flex h-full max-w-[400px] flex-col overflow-hidden rounded-2xl bg-white shadow-md transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border border-gray-100 mx-auto" data-aos="zoom-in">
    ...
    <div class="flex grow flex-col p-7">
        ...
        <h3 class="mb-1 line-clamp-2 min-h-[3rem] text-3xl font-bold leading-tight text-gray-800 transition-colors group-hover:text-[#3b4279]">
            {{ $item->title }}
        </h3>
        ...
        <div class="mt-auto">
            <x-links.detail 
                ...
                class="block w-full rounded-xl bg-blue-600 px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-white shadow-lg transition-all active:scale-95 hover:bg-[#2d3158] hover:shadow-[#3b4279]/30"
            >
                Lihat Lengkap &rarr;
            </x-links.detail>
        </div>
